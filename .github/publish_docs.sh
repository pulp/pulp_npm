...
openssl aes-256-cbc -K $encrypted_None_key -iv $encrypted_None_iv -in .github/pulp-infra.enc -out ~/.ssh/pulp-infra -d
...
python3 docs-builder.py --build-type $1 --branch ${GITHUB_REF##*/}
