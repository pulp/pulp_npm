...
COMPONENT_SOURCE="./pulp_npm/dist/pulp_npm-${COMPONENT_VERSION}-py3-none-any.whl"
if [ "$TEST" = "s3" ]; then
...
legacy_component_name: "pulp_npm"
component_name: "npm"
component_version: "${COMPONENT_VERSION}"
pulp_env: {}
pulp_settings: {"api_root": "/pulp/", "orphan_protection_time": 0}
pulp_scheme: "https"
image:
  name: "pulp"
  tag: "ci_build"
  ...
  webserver_snippet: $(test -f pulp_npm/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_npm"
    destination: "pulp_npm"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
