...
mkdir -p ../npm-bindings
tar -xvf npm-python-client-docs.tar --directory ../npm-bindings
pushd ../npm-bindings
...
rsync -avzh site/ doc_builder_pulp_npm@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_npm_client/en/"$2"
popd
