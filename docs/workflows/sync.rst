...
``$ http POST $BASE_ADDR/pulp/pulp/api/v3/remotes/npm/npm/ name='bar' url='http://some.url/somewhere/'``
...
sync with. You are telling pulp to fetch content from the remote and add to the repository::
    ...
    $ http POST $BASE_ADDR/pulp/api/v3/repositories/npm/npm/9b19ceb7-11e1-4309-9f97-bcbab2ae38b6/sync/' remote=$REMOTE_HREF
...
Response::

    {
        ...
        "created_resources": [
            "http://localhost:24817/pulp/api/v3/repositories/npm/npm/9b19ceb7-11e1-4309-9f97-bcbab2ae38b6/versions/6/"
        ],
        "error": null,
