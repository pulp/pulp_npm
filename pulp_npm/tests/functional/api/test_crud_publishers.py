...
from pulp_npm.tests.functional.constants import NPM_PUBLISHER_PATH, NPM_REPO_PATH
from pulp_npm.tests.functional.utils import gen_npm_publisher, skip_if
...
class CRUDPublishersTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.publisher = {}
        cls.repo = cls.client.post(NPM_REPO_PATH, gen_repo())
    ...
    def test_01_create_publisher(self):
        """Create a publisher."""
        body = gen_npm_publisher()
        type(self).publisher = self.client.post(NPM_PUBLISHER_PATH, body)
    ...
    def test_02_create_same_name(self):
        ...
        with self.assertRaises(HTTPError):
            self.client.post(NPM_PUBLISHER_PATH, body)
    ...
    def test_02_read_publishers(self):
        ...
        page = self.client.get(NPM_PUBLISHER_PATH, params={"name": self.publisher["name"]})
